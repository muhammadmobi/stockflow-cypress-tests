...
export const importAttributesAndCategories = () => {
    ...
    // Step 2: Enable "Allow Import/Export of Attributes" toggle
    configPage.enableAllowImportExportAttributes();
    ...
    attribPage.importAttributesFromFile('cypress/fixtures/testDataAttributes.json');
};
